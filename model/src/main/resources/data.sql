...
INSERT INTO Bioskop(id, adresa, broj_telefona_centrale, email, naziv) values (2, 'Marsala Tita', 32, 'bioskop2@gmail.com', 'Bioskop2');
INSERT INTO Bioskop(id, adresa, broj_telefona_centrale, email, naziv) values (5, 'Zarka Zrenjanina', 2, 'bioskop5@gmail.com', 'Bioskop5');
INSERT INTO Korisnik(type, id,ime, prezime,korisnicko_ime,lozinka,e_mail,datum_rodjenja,telefon, uloga,aktivan) values
